...
export async function getSuggestions(req, res) {
    ...
    if (questions.length === 0) {
        ...
        prompt = "Suggest me new questions based on the topics covered in the following questions and respond using this json JSON schema Question = {'questionName': string} Topic = {'topicName': string, 'questionList': Array<Question>} Return: Array<Topic>`;"
    ...
    try {
        ...
        const data = geminiResult.response.text();
